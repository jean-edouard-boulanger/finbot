...
export FINBOT_APPWSRV_ENDPOINT=http://127.0.0.1:${FINBOT_APPWSRV_PORT}/api/v1
export FINBOT_SNAPWSRV_PORT=5000
export FINBOT_SNAPWSRV_ENDPOINT=http://127.0.0.1:${FINBOT_SNAPWSRV_PORT}
export FINBOT_FINBOTWSRV_PORT=5001
export FINBOT_FINBOTWSRV_ENDPOINT=http://127.0.0.1:${FINBOT_FINBOTWSRV_PORT}
export FINBOT_HISTWSRV_PORT=5002
export FINBOT_HISTWSRV_ENDPOINT=http://127.0.0.1:${FINBOT_HISTWSRV_PORT}
export FINBOT_WEBAPP_PORT=5005
export FINBOT_WEBAPP_ENDPOINT=http://127.0.0.1:${FINBOT_WEBAPP_PORT}
export FINBOT_SCHEDSRV_PORT=5006
export FINBOT_SCHEDSRV_ENDPOINT="tcp://127.0.0.1:${FINBOT_SCHEDSRV_PORT}"
export FINBOT_RMQ_HOSTNAME=127.0.0.1
export FINBOT_RMQ_PORT=5672
export FINBOT_RMQ_USER=finbot
export FINBOT_RMQ_URL="amqp://${FINBOT_RMQ_USER}:${FINBOT_RMQ_PASSWORD}@${FINBOT_RMQ_HOSTNAME}:${FINBOT_RMQ_PORT}"
