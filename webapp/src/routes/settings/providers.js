...
export const EditProviderPanel = (props) => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      toast.error("Could not save provider: invalid credentials schema (invalid JSON syntax)")
      setSubmitting(false);
      return;
    }
              ...
              <Row className={"mb-4"}>
                <Col>
                  <Form.Group>
                    ...
                    <Field type="text" name="id" className="form-control" disabled={!isNew} />
                    <ErrorMessage className="text-danger" name="id" component="div" />
                  </Form.Group>
                  <Form.Group>
                  ...
                  <Form.Group>
                    ...
                    <Field type="text" name="website_url" className="form-control" />
                    <ErrorMessage className="text-danger" name="website_url" component="div" />
                  </Form.Group>
                </Col>
              </Row>
              <Row className={"mb-4"}>
                        ...
                        <Col>
                          {
                            (schemaError === null) &&
                              <DataDrivenForm
                                 ...
                                 showErrorList={false} >
                                <Button hidden disabled size={"xs"}>Hidden</Button>
                              </DataDrivenForm>
                          }
                          {
                            (schemaError !== null) &&
