...
const formatDuration = (d) => {
  ...
  switch (true) {
      case (d < limits.now): return nowFmt(d);
      case (d >= limits.now && d < limits.seconds): return secondsFmt(d);
      case (d >= limits.seconds && d < limits.minutes): return minutesFmt(d);
      case (d >= limits.minutes && d < limits.hours): return hoursFmt(d);
