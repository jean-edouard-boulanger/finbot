...
export function AppGetProviderResponseFromJSON(json: any): AppGetProviderResponse {
    return AppGetProviderResponseFromJSONTyped(json, false);
}

export function AppGetProviderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppGetProviderResponse {
...
export function AppGetProviderResponseToJSON(value?: AppGetProviderResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
