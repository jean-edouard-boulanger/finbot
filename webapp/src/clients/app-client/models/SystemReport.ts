...
export function instanceOfSystemReport(value: object): value is SystemReport {
    if (!('finbotVersion' in value) || value['finbotVersion'] === undefined) return false;
    if (!('finbotApiVersion' in value) || value['finbotApiVersion'] === undefined) return false;
...
export function SystemReportFromJSONTyped(json: any, ignoreDiscriminator: boolean): SystemReport {
    if (json == null) {
        return json;
    }
    return {
...
export function SystemReportToJSONTyped(value?: SystemReport | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
