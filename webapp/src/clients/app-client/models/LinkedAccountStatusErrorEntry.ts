 ...
 */
export function instanceOfLinkedAccountStatusErrorEntry(value: object): boolean {
    let isInstance = true;
...
export function LinkedAccountStatusErrorEntryToJSON(value?: LinkedAccountStatusErrorEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
