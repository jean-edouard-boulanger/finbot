...
export function ValuationChangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValuationChange {
    ...
    return {
        ...
        'change1hour': !exists(json, 'change_1hour') ? undefined : json['change_1hour'],
        'change1day': !exists(json, 'change_1day') ? undefined : json['change_1day'],
        'change1week': !exists(json, 'change_1week') ? undefined : json['change_1week'],
        'change1month': !exists(json, 'change_1month') ? undefined : json['change_1month'],
        'change6months': !exists(json, 'change_6months') ? undefined : json['change_6months'],
        'change1year': !exists(json, 'change_1year') ? undefined : json['change_1year'],
        'change2years': !exists(json, 'change_2years') ? undefined : json['change_2years'],
    };
}
