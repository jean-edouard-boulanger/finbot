...
export function SubAccountItemDescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubAccountItemDescription {
    ...
    return {
        ...
        'icon': !exists(json, 'icon') ? undefined : SubAccountItemNodeIconFromJSON(json['icon']),
    };
}

export function SubAccountItemDescriptionToJSON(value?: SubAccountItemDescription | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
