 ...
 */
export function instanceOfSubAccountItemNode(value: object): value is SubAccountItemNode {
...
export function SubAccountItemNodeToJSONTyped(value?: SubAccountItemNode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
