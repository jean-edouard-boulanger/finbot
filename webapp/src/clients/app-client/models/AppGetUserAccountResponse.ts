...
export function AppGetUserAccountResponseFromJSON(json: any): AppGetUserAccountResponse {
    return AppGetUserAccountResponseFromJSONTyped(json, false);
}

export function AppGetUserAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppGetUserAccountResponse {
...
export function AppGetUserAccountResponseToJSON(value?: AppGetUserAccountResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
