 ...
 */
export function instanceOfAppGetLinkedAccountsHistoricalValuation(value: object): boolean {
    let isInstance = true;
...
export function AppGetLinkedAccountsHistoricalValuationFromJSON(json: any): AppGetLinkedAccountsHistoricalValuation {
    return AppGetLinkedAccountsHistoricalValuationFromJSONTyped(json, false);
}

export function AppGetLinkedAccountsHistoricalValuationFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppGetLinkedAccountsHistoricalValuation {
...
export function AppGetLinkedAccountsHistoricalValuationToJSON(value?: AppGetLinkedAccountsHistoricalValuation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
