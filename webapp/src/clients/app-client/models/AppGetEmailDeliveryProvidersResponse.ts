 ...
 */
export function instanceOfAppGetEmailDeliveryProvidersResponse(value: object): boolean {
    let isInstance = true;
...
export function AppGetEmailDeliveryProvidersResponseFromJSON(json: any): AppGetEmailDeliveryProvidersResponse {
    return AppGetEmailDeliveryProvidersResponseFromJSONTyped(json, false);
}

export function AppGetEmailDeliveryProvidersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppGetEmailDeliveryProvidersResponse {
...
export function AppGetEmailDeliveryProvidersResponseToJSON(value?: AppGetEmailDeliveryProvidersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
