 ...
 */
export function instanceOfValuationWithSparkline(value: object): value is ValuationWithSparkline {
...
export function ValuationWithSparklineFromJSON(json: any): ValuationWithSparkline {
    return ValuationWithSparklineFromJSONTyped(json, false);
}

export function ValuationWithSparklineFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValuationWithSparkline {
    if (json == null) {
        return json;
    }
    return {
...
export function ValuationWithSparklineToJSON(json: any): ValuationWithSparkline {
    return ValuationWithSparklineToJSONTyped(json, false);
}

export function ValuationWithSparklineToJSONTyped(value?: ValuationWithSparkline | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
