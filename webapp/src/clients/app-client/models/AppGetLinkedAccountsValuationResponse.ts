 ...
 */
export function instanceOfAppGetLinkedAccountsValuationResponse(value: object): boolean {
    let isInstance = true;
...
export function AppGetLinkedAccountsValuationResponseFromJSON(json: any): AppGetLinkedAccountsValuationResponse {
    return AppGetLinkedAccountsValuationResponseFromJSONTyped(json, false);
}

export function AppGetLinkedAccountsValuationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppGetLinkedAccountsValuationResponse {
...
export function AppGetLinkedAccountsValuationResponseToJSON(value?: AppGetLinkedAccountsValuationResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
