 ...
 */
export function instanceOfLinkedAccountStatus(value: object): value is LinkedAccountStatus {
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('errors' in value) || value['errors'] === undefined) return false;
    if (!('lastSnapshotId' in value) || value['lastSnapshotId'] === undefined) return false;
    if (!('lastSnapshotTime' in value) || value['lastSnapshotTime'] === undefined) return false;
    return true;
}
...
export function LinkedAccountStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkedAccountStatus {
    ...
    return {
        ...
        'status': json['status'],
        'errors': ((json['errors'] as Array<any>).map(LinkedAccountStatusErrorEntryFromJSON)),
...
export function LinkedAccountStatusToJSONTyped(value?: LinkedAccountStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'status': value['status'],
        'errors': ((value['errors'] as Array<any>).map(LinkedAccountStatusErrorEntryToJSON)),
