...
export function AppHistoricalValuationParamsFromJSON(json: any): AppHistoricalValuationParams {
    return AppHistoricalValuationParamsFromJSONTyped(json, false);
}

export function AppHistoricalValuationParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppHistoricalValuationParams {
    ...
    return {
        ...
        'frequency': !exists(json, 'frequency') ? undefined : ValuationFrequencyFromJSON(json['frequency']),
    };
}

export function AppHistoricalValuationParamsToJSON(value?: AppHistoricalValuationParams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
