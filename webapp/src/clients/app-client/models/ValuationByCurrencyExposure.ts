 ...
 */
export function instanceOfValuationByCurrencyExposure(value: object): value is ValuationByCurrencyExposure {
    if (!('valuationCcy' in value) || value['valuationCcy'] === undefined) return false;
    if (!('byCurrencyExposure' in value) || value['byCurrencyExposure'] === undefined) return false;
    return true;
}
...
export function ValuationByCurrencyExposureToJSON(json: any): ValuationByCurrencyExposure {
    return ValuationByCurrencyExposureToJSONTyped(json, false);
}

export function ValuationByCurrencyExposureToJSONTyped(value?: ValuationByCurrencyExposure | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
