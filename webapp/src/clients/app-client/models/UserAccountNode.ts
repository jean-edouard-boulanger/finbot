...
export type UserAccountNodeRoleEnum = typeof UserAccountNodeRoleEnum[keyof typeof UserAccountNodeRoleEnum];


/**
 * Check if a given object implements the UserAccountNode interface.
 */
export function instanceOfUserAccountNode(value: object): value is UserAccountNode {
...
export function UserAccountNodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserAccountNode {
    if (json == null) {
        return json;
    }
    return {
...
export function UserAccountNodeToJSONTyped(value?: UserAccountNode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
