...
export function AppEmailDeliverySettingsFromJSON(json: any): AppEmailDeliverySettings {
    return AppEmailDeliverySettingsFromJSONTyped(json, false);
}

export function AppEmailDeliverySettingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppEmailDeliverySettings {
...
export function AppEmailDeliverySettingsToJSON(value?: AppEmailDeliverySettings | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
