 ...
 */
export function instanceOfAppGetUserAccountValuationHistoryResponse(value: object): boolean {
    let isInstance = true;
...
export function AppGetUserAccountValuationHistoryResponseFromJSON(json: any): AppGetUserAccountValuationHistoryResponse {
    return AppGetUserAccountValuationHistoryResponseFromJSONTyped(json, false);
}

export function AppGetUserAccountValuationHistoryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppGetUserAccountValuationHistoryResponse {
...
export function AppGetUserAccountValuationHistoryResponseToJSON(value?: AppGetUserAccountValuationHistoryResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
