...
export function AppGetLinkedAccountsResponseFromJSON(json: any): AppGetLinkedAccountsResponse {
    return AppGetLinkedAccountsResponseFromJSONTyped(json, false);
}

export function AppGetLinkedAccountsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppGetLinkedAccountsResponse {
...
export function AppGetLinkedAccountsResponseToJSON(value?: AppGetLinkedAccountsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
