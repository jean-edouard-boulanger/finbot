...
export function AppIsEmailAvailableResponseFromJSON(json: any): AppIsEmailAvailableResponse {
    return AppIsEmailAvailableResponseFromJSONTyped(json, false);
}

export function AppIsEmailAvailableResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppIsEmailAvailableResponse {
...
export function AppIsEmailAvailableResponseToJSON(value?: AppIsEmailAvailableResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
