 ...
 */
export function instanceOfGetEmailDeliveryProvidersResponse(value: object): value is GetEmailDeliveryProvidersResponse {
    if (!('providers' in value) || value['providers'] === undefined) return false;
    return true;
}

export function GetEmailDeliveryProvidersResponseFromJSON(json: any): GetEmailDeliveryProvidersResponse {
    return GetEmailDeliveryProvidersResponseFromJSONTyped(json, false);
}

export function GetEmailDeliveryProvidersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetEmailDeliveryProvidersResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'providers': ((json['providers'] as Array<any>).map(EmailProviderMetadataFromJSON)),
    };
}

export function GetEmailDeliveryProvidersResponseToJSON(json: any): GetEmailDeliveryProvidersResponse {
    return GetEmailDeliveryProvidersResponseToJSONTyped(json, false);
}

export function GetEmailDeliveryProvidersResponseToJSONTyped(value?: GetEmailDeliveryProvidersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
