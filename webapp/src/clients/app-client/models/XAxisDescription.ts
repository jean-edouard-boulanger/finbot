 ...
 */
export function instanceOfXAxisDescription(value: object): value is XAxisDescription {
...
export function XAxisDescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): XAxisDescription {
    if (json == null) {
        return json;
    }
    return {
...
export function XAxisDescriptionToJSONTyped(value?: XAxisDescription | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
