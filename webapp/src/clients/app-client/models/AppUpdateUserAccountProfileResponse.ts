 ...
 */
export function instanceOfAppUpdateUserAccountProfileResponse(value: object): boolean {
    let isInstance = true;
...
export function AppUpdateUserAccountProfileResponseFromJSON(json: any): AppUpdateUserAccountProfileResponse {
    return AppUpdateUserAccountProfileResponseFromJSONTyped(json, false);
}

export function AppUpdateUserAccountProfileResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppUpdateUserAccountProfileResponse {
...
export function AppUpdateUserAccountProfileResponseToJSON(value?: AppUpdateUserAccountProfileResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
