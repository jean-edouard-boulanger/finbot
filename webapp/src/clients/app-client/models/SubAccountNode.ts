...
export type SubAccountNodeRoleEnum = typeof SubAccountNodeRoleEnum[keyof typeof SubAccountNodeRoleEnum];


/**
 * Check if a given object implements the SubAccountNode interface.
 */
export function instanceOfSubAccountNode(value: object): value is SubAccountNode {
...
export function SubAccountNodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubAccountNode {
    if (json == null) {
        return json;
    }
    return {
...
export function SubAccountNodeToJSONTyped(value?: SubAccountNode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
