 ...
 */
export function instanceOfLinkedAccountValuationEntry(value: object): value is LinkedAccountValuationEntry {
...
export function LinkedAccountValuationEntryFromJSON(json: any): LinkedAccountValuationEntry {
    return LinkedAccountValuationEntryFromJSONTyped(json, false);
}

export function LinkedAccountValuationEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkedAccountValuationEntry {
    if (json == null) {
        return json;
    }
    return {
        
        'linkedAccount': LinkedAccountValuationLinkedAccountDescriptionFromJSON(json['linked_account']),
        'valuation': LinkedAccountValuationFromJSON(json['valuation']),
    };
}

export function LinkedAccountValuationEntryToJSON(json: any): LinkedAccountValuationEntry {
    return LinkedAccountValuationEntryToJSONTyped(json, false);
}

export function LinkedAccountValuationEntryToJSONTyped(value?: LinkedAccountValuationEntry | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'linked_account': LinkedAccountValuationLinkedAccountDescriptionToJSON(value['linkedAccount']),
