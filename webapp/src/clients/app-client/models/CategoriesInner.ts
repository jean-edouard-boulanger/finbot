 ...
 */
export function instanceOfCategoriesInner(value: object): value is CategoriesInner {
    return true;
}
...
export function CategoriesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoriesInner {
    return json;
}
...
export function CategoriesInnerToJSONTyped(value?: CategoriesInner | null, ignoreDiscriminator: boolean = false): any {
    return value;
}
