 ...
 */
export function instanceOfUserAccountValuation(value: object): value is UserAccountValuation {
...
export function UserAccountValuationFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserAccountValuation {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sparkline': ((json['sparkline'] as Array<any>).map(UserAccountValuationSparklineEntryFromJSON)),
    };
}
...
export function UserAccountValuationToJSONTyped(value?: UserAccountValuation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sparkline': ((value['sparkline'] as Array<any>).map(UserAccountValuationSparklineEntryToJSON)),
    };
}
