...
export type LinkedAccountNodeRoleEnum = typeof LinkedAccountNodeRoleEnum[keyof typeof LinkedAccountNodeRoleEnum];


/**
 * Check if a given object implements the LinkedAccountNode interface.
 */
export function instanceOfLinkedAccountNode(value: object): value is LinkedAccountNode {
...
export function LinkedAccountNodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkedAccountNode {
    if (json == null) {
        return json;
    }
    return {
...
export function LinkedAccountNodeToJSONTyped(value?: LinkedAccountNode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
